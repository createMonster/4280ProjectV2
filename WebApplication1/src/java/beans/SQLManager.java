...
public class SQLManager {
    private final String REGISTER = "INSERT into CCWuser VALUES(?, ?, ?, ?, ?)";
    private final String NEWCUSTOMER = "NSERT INTO CCWuser VALUES()";
    private final String GETFLIGHTS = "SELECT * FROM CCWflight where DepAirport = ? and ArrAirport = ? and DepTime = ? and ArrTime = ?";
